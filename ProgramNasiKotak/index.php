<?php
	...
	//	Function hitung_tagihan_awal digunakan untuk menghitung tagihan awal berdasarkan parameter harga dan jumlah
	function hitung_tagihan_awal($harga, $jumlah){
		// Variable $tagihanAwal berfungsi untuk menghitung harga X jumlah
		$tagihanAwal = $harga * $jumlah;

		// Return digunakan untuk mengembalikan nilai tagihan awal
		return $tagihanAwal;
	}
